...
import (
	...
	cst "github.com/isd-sgcu/rpkm66-backend/constant/checkin"
)
...
func NewService(repo checkin_repo.Repository, cache cache_repo.Repository, conf cfgldr.App) *serviceImpl {
	return &serviceImpl{repo: repo, cache: cache, conf: conf}
}

func (s *serviceImpl) CheckinVerify(_ context.Context, req *proto.CheckinVerifyRequest) (*proto.CheckinVerifyResponse, error) {
...
func (s *serviceImpl) CheckinConfirm(_ context.Context, req *proto.CheckinConfirmRequest) (*proto.CheckinConfirmResponse, error) {
