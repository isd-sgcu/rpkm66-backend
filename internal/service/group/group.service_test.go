...
import (
	...
	size "github.com/isd-sgcu/rpkm66-backend/constant/baan"
	...
	mockCache "github.com/isd-sgcu/rpkm66-backend/mocks/cache"
...
func testUpdateBaanSelectionInvalidNumberOfBaan(t *testing.T, userId string, baanIds []string, conf cfgldr.App) {
	repo := &mock.RepositoryMock{}
