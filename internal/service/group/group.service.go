...
type serviceImpl struct {
	...
	conf               cfgldr.App
	baanGroupSelection baan_group_selection_repo.Repository
}

func NewService(repo group_repo.Repository, userRepo user_repo.Repository, baanGroupSelectionRepo baan_group_selection_repo.Repository, fileSrv file_svc.Service, cacheRepo cache_repo.Repository, baanRepo baan_repo.Repository, conf cfgldr.App) *serviceImpl {
	return &serviceImpl{
		repo:               repo,
		userRepo:           userRepo,
		cacheRepo:          cacheRepo,
...
func (s *serviceImpl) FindOne(_ context.Context, req *proto.FindOneGroupRequest) (res *proto.FindOneGroupResponse, err error) {
...
func (s *serviceImpl) FindByToken(_ context.Context, req *proto.FindByTokenGroupRequest) (res *proto.FindByTokenGroupResponse, err error) {
	raw := &group.Group{}
...
func (s *serviceImpl) Update(_ context.Context, req *proto.UpdateGroupRequest) (res *proto.UpdateGroupResponse, err error) {
...
func (s *serviceImpl) Join(_ context.Context, req *proto.JoinGroupRequest) (res *proto.JoinGroupResponse, err error) {
...
func (s *serviceImpl) DeleteMember(_ context.Context, req *proto.DeleteMemberGroupRequest) (res *proto.DeleteMemberGroupResponse, err error) {
	_, err = uuid.Parse(req.UserId)
	if err != nil {
		log.Error().
			Err(err).
...
func (s *serviceImpl) Leave(_ context.Context, req *proto.LeaveGroupRequest) (res *proto.LeaveGroupResponse, err error) {
	if _, err = uuid.Parse(req.UserId); err != nil {
		log.Error().
			Err(err).
			Str("service", "group").
...
func (s *serviceImpl) SelectBaan(_ context.Context, req *proto.SelectBaanRequest) (res *proto.SelectBaanResponse, err error) {
...
func (s *serviceImpl) RawToDto(in *group.Group) (result *proto.Group, err error) {
...
func (s *serviceImpl) GetMembersImages(users []*user.User) (result []*proto.UserInfo, err error) {
...
func (s *serviceImpl) GetUserImage(usr *user.User) (result string, err error) {
